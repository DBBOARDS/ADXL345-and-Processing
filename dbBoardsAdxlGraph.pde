/*-------------------------------------------------------------------------------------------------------------------------------------
  dbBoardsAdxlGraph.pde
    Use with dbBoardsAdxlGraph.ino
...
void draw(){                             // The draw program runs on a continuous loop after setup finishes
  ...
  getAccelFromArduino();                 // Parse and Store the new x, y, and z values from dbBoardsAdxlGraph.ino
  drawAccelGraph();                      // Draw the shifted graph with the new values
}

void getAccelFromArduino(){              // Parse and Store the new x, y, and z values from dbBoardsAdxlGraph.ino
